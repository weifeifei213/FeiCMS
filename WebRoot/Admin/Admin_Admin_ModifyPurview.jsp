...
网站缓存管理 </td>
											...
											<td>
											<input name='popNum' type='checkbox'
														id='popNum' value='POP000219'   <%if(admin.getAdminPopList().indexOf("POP000219")>=0){out.print("checked");} %>>
													值班信息管理
											</td>
											<td>
											<input name='popNum' type='checkbox'
														id='popNum' value='POP000220'   <%if(admin.getAdminPopList().indexOf("POP000220")>=0){out.print("checked");} %>>
													局长信箱
											</td>
											<td>
											<input name='popNum' type='checkbox'
														id='popNum' value='POP000221'   <%if(admin.getAdminPopList().indexOf("POP000221")>=0){out.print("checked");} %>>
													局长信箱配置
											</td>
