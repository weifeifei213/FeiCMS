	...
	<body leftmargin='2' topmargin='0' marginwidth='0' marginheight='0'>
		<table width='100%' border='0' align='center' cellpadding='2'
			...
			<form name='form3' method='Post'
				action='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&ClassID=0&SpecialID=0&Field=&keyword='>
			<tr class='tdbg'>
				<td width='70' height='30'>
					<strong>文章选项：</strong>
				</td>
		...
		<table width='100%' border='0' align='center' cellpadding='2'
			...
			<tr class='title'>
				<td height='22'>
					|
					<a
						href='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&SpecialID=1'>自设内容</a>
					|
				</td>
			</tr>
		</table>
		...
		<table width='100%' border='0' align='center' cellpadding='0'
			...
			<tr>
				<td height='22'>
					您现在的位置：&nbsp;文章中心管理&nbsp;&gt;&gt;&nbsp;
					<a
						href='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special'>专题文章管理</a>&nbsp;&gt;&gt;&nbsp;所有文章！
				</td>
				<td width='200' height='22' align='right'>
					<select name='JumpClass' id='JumpClass'
						onChange="if(this.options[this.selectedIndex].value!=''){location='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&ClassID='+this.options[this.selectedIndex].value;}">
...
阅读点数：0'>文章标题</a>
							...
							<td width='60' align='center'>
								<a
									href='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&field=Inputer&keyword=admin'
						...
						<tr>
							...
							<td>
								<input name='submit1' type='submit' id='submit1'
									onClick="document.myform.Action.value='DelFromSpecial'"
									value='从所属专题中移除'>
								<input name='Submit2' type='submit' id='Submit2'
									onClick="document.myform.Action.value='AddToSpecial'"
									value='添加到其他专题中'>
								<input name='Submit2' type='submit' id='Submit2'
									onClick="document.myform.Action.value='MoveToSpecial'"
									value='移动到另一专题中'>
		...
		<div class="show_page">
			...
			<input type='text' name='MaxPerPage' size='3' maxlength='4'
				value='20'
				onKeyPress="if (event.keyCode==13) window.location='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&ClassID=0&SpecialID=0&Field=&keyword=&Status=9&Created=&PayStatus=False&OnTop=&IsElite=&IsHot=&page=1&MaxPerPage='+this.value;">
			篇文章/页&nbsp;转到：
			<select name='page' size='1'
				onChange="javascript:window.location='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special&ClassID=0&SpecialID=0&Field=&keyword=&Status=9&Created=&PayStatus=False&OnTop=&IsElite=&IsHot=&MaxPerPage=20&page='+this.options[this.selectedIndex].value;">
		...
		<form method='Get' name='SearchForm'
			action='Admin_Article.asp?ChannelID=1&Action=Manage&ManageType=Special'>
