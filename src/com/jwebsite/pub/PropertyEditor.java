...
public class PropertyEditor {  
    public static void main(String[] args) throws Exception {  
    	...
    	URL url=ClassLoader.getSystemResource("mdb.properties");
        ...
        //prop.load(PropertyEditor.class.getClassLoader().getResourceAsStream("mdb.properties"));// 将属性文件流装载到Properties对象中  
        fis.close();// 关闭流  
  ...
  /*
        ...
        fos.close();// 关闭流  
       */
       // System.out.println("获取属性值：country=" + prop.getProperty("sitename"));  
